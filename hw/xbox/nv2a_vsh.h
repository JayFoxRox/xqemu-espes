...
enum VshAttributeType {
    ATTRIBUTE_TYPE_NORMALIZED_UINT8_BGRA,
    ATTRIBUTE_TYPE_NORMALIZED_INT16,
    ATTRIBUTE_TYPE_FLOAT,
    ATTRIBUTE_TYPE_ERROR3,
    ATTRIBUTE_TYPE_NORMALIZED_UINT8_RGBA,
    ATTRIBUTE_TYPE_INT16,
    ATTRIBUTE_TYPE_COMPRESSED
};
