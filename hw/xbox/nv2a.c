...
static const ColorFormatInfo kelvin_color_format_map[66] = {
    ...
    /* FIXME: How does FIXED/FLOAT work? */
    ...
    [NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_DEPTH_X8_Y24_FLOAT] =
        {4, true, GL_DEPTH32F_STENCIL8, GL_DEPTH_STENCIL, GL_FLOAT_32_UNSIGNED_INT_24_8_REV},
    ...
    [NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_DEPTH_Y16_FLOAT] =
        {2, true, GL_DEPTH_COMPONENT32F, GL_DEPTH_COMPONENT, GL_HALF_FLOAT},
...
static void pgraph_init(NV2AState *d)
{
    ...
    /*  Internal RGB565 texture format + HALF_FLOAT */
